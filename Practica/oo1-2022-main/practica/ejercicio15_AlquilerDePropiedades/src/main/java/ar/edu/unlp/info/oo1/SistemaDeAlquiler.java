...
public class SistemaDeAlquiler {
	...
	dirección. Se provee el usuario propietario. El sistema da de alta la propiedad y la retorna.
	La propiedad no tiene ninguna fecha ocupada.*/
	public Propiedad registrarPropiedad(String nombre, String descripcion, double precioNoche, String direccion, Usuario propietario) {
		...
		return propietario.registrarPropiedad(nombre, descripcion, precioNoche, direccion);
	}
